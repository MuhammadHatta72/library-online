            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="form-id" action="{{ route('buku.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('kode_buku') is-invalid @enderror"
                                            id="kode_buku" name="kode_buku" value="{{ old('kode_buku') ? old('kode_buku') : 'BK' . date('YmdHis') }}" readonly />
                                        @error('kode_buku')
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                            id="deskripsi" name="deskripsi" rows="3" style="height: 100px;">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lemari') is-invalid @enderror"
                                            id="lemari" name="lemari" value="{{ old('lemari') }}" />
                                        @error('lemari')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
