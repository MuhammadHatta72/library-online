...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/pppbulutuban.png') }}">
    <title>@yield('title') - UPT PPP Bulu Tuban</title>
    ...
    <link href="{{ asset('assets/css/vendor/fontawesome-free-5.15.4-web/css/all.css') }}" rel="stylesheet">
    ...
    {{--    select 2 --}}
    <link rel="stylesheet" href="{{ asset('assets/css/vendor/select2/select2.min.css') }}">
